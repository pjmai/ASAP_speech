...
def listen_print_loop(responses):
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            keyboard.write(transcript + overwrite_chars)
            ...
            if re.search(r"\b(command mode)\b", transcript, re.I):
                ...
                print("Command Mode is {}".format(command_mode))
                #break
            if command_mode:
                ...
                if re.search(r"\b(option A|option 1)\b", transcript, re.I):
                    print("FIRST OPTION..")
                    #break
...
def main():
    ...
    language_code = "en-US"  # a BCP-47 language tag nl-BE
